...
in.dir <- out.dir <-  "/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/CMOP_field/model"
...
for(t in 1:23){
	...
	Par.path <- paste(in.dir,"/Par_",cruise,sep="")
...
for(i in 1:length(days)){
	...
	### RUN size.class.model_functions
	    ...
	    save(model, file=paste(in.dir,"/",phyto,"_modelHD_growthV3_",cruise,"_Ncat",m,"_t",t, sep=""))
