#model code order:
#1.cruise size dist 2.conversion size dist 3.vis size dist 4.model HD div rate 5.model output vis
...
# for i in $(seq 1 1 18); do echo "Rscript Cruise_Size_distribution.R $i crypto CMOP_6" | qsub -lwalltime=00:30:00,nodes=1:ppn=1 -N crypto_dist$i -d.; done
