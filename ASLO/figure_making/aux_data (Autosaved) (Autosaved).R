...
flu <- subset(pre.flu2, time > as.POSIXct("2013-09-10 16:50:00") & time < as.POSIXct("2013-10-03 23:58:00"))
#2013-09-26 00:50:00

plot(pre.flu2$time, pre.flu2$water_salinity, pch=16, ylab="turbidity", xlab="time", cex.lab=1.5)
