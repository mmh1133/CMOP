...
abundance.sd <- c(d1m.c.sd, d2m.c.sd, d3m.c.sd, d7m.c.sd, d8m.c.sd, d9m.c.sd, d13m.c.sd, d14m.c.sd, d15m.c.sd, d16m.c.sd, d17m.c.sd, d21m.c.sd, d22m.c.sd)

abundance.n <- c(368, 189, 174, 214, 325, 12, 144, 331, 290, 261, 65, 234, 189)
...
dm.sd <- c(d1m.sd, d2m.sd, d3m.sd, d7m.sd, d8m.sd, d9m.sd, d13m.sd, d14m.sd, d15m.sd, d16m.sd, d17m.sd, d21m.sd, d22m.sd)
...
mtext(2, text="salinity (psu)", line=3.7, cex=1.5)
par(new=T)
...
axis(4, cex.axis=2)
mtext(4, text="water temperature \n(degree C)", line=5.5, cex=1.5)
mtext("A", side=3, cex=2, adj=0)
legend("topright", c("salinity", "temperature"), lty=c(1,1), lwd=c(4,4), col=c("black", "darkgrey"), cex=1.7)
...
mtext(2, text="PAR", line=4.5, cex=1.5)
mtext("B", side=3, cex=2, adj=0)

# nutrients #
#par(mar=c(5,12,4,12))
plot(pre.flu2$time2, pre.flu2$Nitrate, lwd=2, pch=16, cex=1.5, xlab="", ylab="", cex.lab=1.7, ylim=c(0,22), las=1, cex.axis=2)
mtext(substitute(paste("nitrate (", mu,"M)")), side=2, cex=1.5, line=3.1)
par(new=T)
plot(pre.flu2$time2, pre.flu2$Ammonium, lwd=2, pch=0, cex=1, xlab="", ylab="", axes=F, ylim=c(0,100), las=1, cex.axis=2)
axis(2, line=5.7, cex.axis=2)
mtext(substitute(paste("ammonium (", mu, "M)")), side=2, line=8.7, cex=1.5)
par(new=T)
plot(pre.flu2$time2, pre.flu2$Phosphate, lwd=2, pch=4, cex=1, xlab="", ylab="", axes=F, ylim=c(0, 2), las=1, cex.axis=2)
axis(4, cex.axis=2)
mtext(substitute(paste("phosphate (", mu, "M)")),side=4, line=4, cex=1.5)
legend("topright", c("nitrate", "ammonium", "phosphate"), pch=c(16, 0, 4), cex=1.8, ncol=3)
...
#week 1
#par(mai=c(1,1.5,1,1))
plotCI(dr.w1$time, dr.w1$daily.GRmean, uiw= dr.w1$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1.7, xaxt="n", las=1, ylim=c(0,11), xlim=c(as.POSIXct("2013-09-11 00:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-14 00:00:00", origin="1970-01-01", tz='GMT')))
axis.POSIXct(1, dr.w1$time, at=seq(as.POSIXct("2013-09-11 00:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-14 00:00:00", origin="1970-01-01", tz='GMT'), by=60*60*12), format="%m-%d %H:%M", cex.axis=1.75)
par(new=T)
...
#week2
#par(mai=c(1,1.5,1,1))
plotCI(dr.w2$time, dr.w2$daily.GRmean, uiw= dr.w2$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1.7, xaxt="n", las=1, ylim=c(0,11),  xlim=c(as.POSIXct("2013-09-17 06:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-19 12:00:00", origin="1970-01-01", tz='GMT')))
axis.POSIXct(1, dr.w2$time, at=seq(as.POSIXct("2013-09-17 07:00:00", origin="1970-01-01", tz='GMT'), max(dr.w2$time, na.rm=T), by=60*60*12), format="%m-%d %H:%M", cex.axis=1.75)
par(new=T)
...
#week3
#par(mai=c(1,1.5,1,1))
plotCI(dr.w3$time, dr.w3$daily.GRmean, uiw= dr.w3$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1.7, xaxt="n", las=1, ylim=c(0,11), xlim=c(as.POSIXct("2013-09-23 09:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-27 20:00:00", origin="1970-01-01", tz='GMT')))
axis.POSIXct(1, dr.w3$time, at=seq(as.POSIXct("2013-09-22 07:00:00", origin="1970-01-01", tz='GMT'), max(dr.w3$time, na.rm=T), by=60*60*12), format="%m-%d %H:%M", cex.axis=1.6)
par(new=T)
...
#week4
#par(mai=c(1,1.5,1,1))
plotCI(dr.w4$time,dr.w4$daily.GRmean, uiw= dr.w4$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1.7, xaxt="n", las=1, ylim=c(0,11), xlim=c(as.POSIXct("2013-10-01 06:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-10-02 13:00:00", origin="1970-01-01", tz='GMT')) )
axis.POSIXct(1, dr.w4$time, at=seq(as.POSIXct("2013-09-29 11:00:00", origin="1970-01-01", tz='GMT'), max(dr.w4$time, na.rm=T), by=60*60*12), format="%m-%d %H:%M", cex.axis=1.75)
par(new=T)
...
#nitrate
#par(mai=c(1,1,1,7))
plot(cmop.meso$n.meso, cmop.meso$meso, pch=16, xlab="nitrate", ylab="M. major abundance", cex.lab=1.7, cex=1.5, xlim=c(0,14), cex.axis=1.7)
#res1=lm(cmop$dm~cmop$n)
...
#phosphate
# par(mai=c(1,1,1,7))
plot(cmop.meso$ph.meso, cmop.meso$meso, pch=16, xlab="phosphate", ylab="", cex.lab=1.7, cex=1.5, xlim=c(0,1.3), cex.axis=1.7)
#res2=lm(cmop$dm~cmop$ph)
...
#ammonium
# par(mai=c(1,1,1,7))
plot(cmop.meso$a.meso, cmop.meso$meso, pch=16, xlab="ammonium", ylab="M. major abundance", cex.lab=1.7, cex=1.5, xlim=c(0,14), cex.axis=1.7)
#res3=lm(cmop$dm~cmop$a)
...
#par(mai=c(1,1,1,7))
plot(cmop.meso$par.meso, cmop.meso$meso, pch=16, xlab="PAR", ylab="", cex.lab=1.7, cex=1.5, xlim=c(0,250), cex.axis=1.7)
#res4=lm(cmop$dm~cmop$par.cum)
...
#nitrate
#par(mai=c(1,1,1,7))
plotCI(cmop.pro$n, cmop.pro$production, uiw=cmop.pro$production.se, sfac=0, pch=16, xlab="nitrate", ylab="production", cex.lab=1.7, cex=1.5, ylim=c(0,3.2), xlim=c(0,14), cex.axis=1.7)
#res1=lm(cmop$dm~cmop$n)
res1 <- lmodel2(cmop.pro$production~cmop.pro$n, data=cmop.pro, nperm=0, range.x="relative", range.y="relative")
par(new=T)
plot(res1, "MA", ylab="", xlab="", main="", col="black", ylim=c(0,3.2), xlim=c(0,14), cex.axis=1.7)
text(5.5,2.75, substitute(paste("R"^{2}, "=0.231")), cex=2)
mtext("A", side=3, cex=2, adj=0)

#phosphate
# par(mai=c(1,1,1,7))
plotCI(cmop.pro$ph, cmop.pro$production, uiw=cmop.pro$production.se, sfac=0, pch=16, xlab="phosphate", ylab="", cex.lab=1.7, cex=1.5, ylim=c(0,3.2), xlim=c(0,1.3), cex.axis=1.7)
#res2=lm(cmop$dm~cmop$ph)
res2 <- lmodel2(cmop.pro$production~cmop.pro$ph, data=cmop.pro, nperm=0, range.x="relative", range.y="relative")
par(new=T)
plot(res2, "MA", ylab="", xlab="", main="", col="black", ylim=c(0,3.2), xlim=c(0,1.3), cex.axis=1.7)
text(0.95,2.75, substitute(paste("R"^{2}, "=0.142")), cex=2)
mtext("B", side=3, cex=2, adj=0)

#ammonium
# par(mai=c(1,1,1,7))
plotCI(cmop.pro$a, cmop.pro$production, uiw=cmop.pro$production.se, sfac=0, pch=16, xlab="ammonium", ylab="production", cex.lab=1.7, cex=1.5, ylim=c(0,3.2), xlim=c(0,14), cex.axis=1.7)
#res3=lm(cmop$dm~cmop$a)
res3 <- lmodel2(cmop.pro$production~cmop.pro$a, data=cmop.pro, nperm=0, range.x="relative", range.y="relative")
par(new=T)
plot(res3, "MA", ylab="", xlab="", main="", col="black", ylim=c(0,3.2), xlim=c(0,14), cex.axis=1.7)
text(11,2.75, substitute(paste("R"^{2}, "=0.004")), cex=2)
mtext("C", side=3, cex=2, adj=0)

#par(mai=c(1,1,1,7))
plotCI(cmop.pro$par.cum, cmop.pro$production, uiw=cmop.pro$production.se, sfac=0, pch=16, xlab="PAR", ylab="", cex.lab=1.7, cex=1.5, ylim=c(0,3.2), xlim=c(0,200), cex.axis=1.7)
#res4=lm(cmop$dm~cmop$par.cum)
res4 <- lmodel2(cmop.pro$production~cmop.pro$par.cum, data=cmop.pro, nperm=0, range.x="relative", range.y="relative")
par(new=T)
plot(res4, "MA", ylab="", xlab="", main="", col="black", ylim=c(0,3.2), xlim=c(0,200), cex.axis=1.7)
text(140,2.75, substitute(paste("R"^{2}, "=0.133")), cex=2)
mtext("D", side=3, cex=2, adj=0)
