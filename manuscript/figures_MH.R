...
png(filename="~/Desktop/aux_ver2.png", width=1000, height=600, units="px", res=100)
...
#week 1 log scale
#par(mai=c(1,1.5,1,1))
plot(crypto.week1$time, crypto.week1$abundance, xaxt="n", xlab="", lwd=2, pch=16, ylab= "", cex.lab=1.5, log="y", col="darkgrey", las=1, cex.axis=1.7, ylim=c(0.0005, 40))
...
axis.POSIXct(1, crypto.week1$time, at=seq(min(crypto.week1$time, na.rm=T), max(crypto.week1$time, na.rm=T), by=60*60*6), format="%m-%d %H:%M", cex.axis=1.7)
...
#week 2 log scale
#par(mai=c(1,1.5,1,1))
plot(crypto.week2$time, crypto.week2$abundance, xaxt="n", xlab="", lwd=2, pch=16, ylab="", cex.lab=1.5, log="y", col="darkgrey", las=1, cex.axis=1.7, ylim=c(0.0005, 40))
...
axis.POSIXct(1, crypto.week2$time, at=seq(as.POSIXct("2013-09-16 20:00:00", origin="1970-01-01", tz='GMT'), max(crypto.week2$time, na.rm=T), by=60*60*6), format="%m-%d %H:%M", cex.axis=1.7)
...
#week 3 log scale
#par(mai=c(1,1.5,1,1))
plot(crypto.week3$time, crypto.week3$abundance, xaxt="n", xlab="", lwd=2, pch=16, ylab="", cex.lab=1.5, ylog=T, log="y", col="darkgrey", las=1, cex.axis=1.7, ylim=c(0.0005, 40))
...
axis.POSIXct(1, crypto.week3$time, at=seq(min(crypto.week3$time, na.rm=T), max(crypto.week3$time, na.rm=T), by=60*60*6), format="%m-%d %H:%M", cex.axis=1.7)
...
axis.POSIXct(1, crypto.week4$time, at=seq(as.POSIXct("2013-09-30 18:50:00", origin="1970-01-01", tz='GMT'), max(crypto.week4$time, na.rm=T), by=60*60*6), format="%m-%d %H:%M", cex.axis=1.7)
...
png(filename="~/Desktop/div_test.png", width=1000, height=650, units="px", res=100)
#quartz("Quartz", width=10, height=6.5)
par(mfrow=c(4,1), mar=c(1.15,5,1.5,2)+0.8, pty="m", cex.axis=1)


#week 1
#par(mai=c(1,1.5,1,1))
plotCI(dr.w1$time, dr.w1$daily.GRmean, uiw= dr.w1$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1, xaxt="n", las=1, ylim=c(0,11), xlim=c(as.POSIXct("2013-09-11 00:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-14 00:00:00", origin="1970-01-01", tz='GMT')))
...
par(new=T)
plot(dr.w1$time, dr.w1$daily.GRmean, xlab="", ylab="", axes=F, type="l", ylim=c(0,11), xlim=c(as.POSIXct("2013-09-11 00:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-14 00:00:00", origin="1970-01-01", tz='GMT')))
...
#week2
#par(mai=c(1,1.5,1,1))
plotCI(dr.w2$time, dr.w2$daily.GRmean, uiw= dr.w2$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1, xaxt="n", las=1, ylim=c(0,11),  xlim=c(as.POSIXct("2013-09-17 06:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-19 12:00:00", origin="1970-01-01", tz='GMT')))
...
par(new=T)
plot(dr.w2$time, dr.w2$daily.GRmean, xlab="", ylab="", axes=F, type="l", ylim=c(0,11),  xlim=c(as.POSIXct("2013-09-17 06:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-19 12:00:00", origin="1970-01-01", tz='GMT')))
...
#week3
#par(mai=c(1,1.5,1,1))
plotCI(dr.w3$time, dr.w3$daily.GRmean, uiw= dr.w3$daily.GRse, sfrac=0, pch=NA, 	xlab="", ylab="", cex.lab=1, xaxt="n", las=1, ylim=c(0,11), xlim=c(as.POSIXct("2013-09-23 09:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-27 20:00:00", origin="1970-01-01", tz='GMT')))
axis.POSIXct(1, dr.w3$time, at=seq(as.POSIXct("2013-09-22 07:00:00", origin="1970-01-01", tz='GMT'), max(dr.w3$time, na.rm=T), by=60*60*12), format="%m-%d %H:%M", cex.axis=1)
par(new=T)
plot(dr.w3$time, dr.w3$daily.GRmean, xlab="", ylab="", axes=F, type="l", ylim=c(0,11), xlim=c(as.POSIXct("2013-09-23 09:00:00", origin="1970-01-01", tz='GMT'), as.POSIXct("2013-09-27 20:00:00", origin="1970-01-01", tz='GMT')))
...
png(filename="~/Desktop/meso_corr_test.png", width=650, height=650, units="px", res=100)
