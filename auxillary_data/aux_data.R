...
pre.flu1 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.AlgaeWatch_2013_08_PD0.csv")
pre.flu2 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.AlgaeWatch_2013_09_PD0.csv")
pre.flu3 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.AlgaeWatch_2013_10_PD0.csv")

pre.flu1 <- as.data.frame(pre.flu1, row.names=NULL)
pre.flu2 <- as.data.frame(pre.flu2, row.names=NULL)
pre.flu3 <- as.data.frame(pre.flu3, row.names=NULL)

flu<- rbind(pre.flu1, pre.flu2, pre.flu3)

flu$time <- as.POSIXct(strptime(flu$time, "%Y/%m/%d %H:%M:%S"), tz="GMT")

write.csv(flu, paste("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/fluorescence",cruise, sep=""), quote=F, row.names=F)

# fluorescence (Phytoflash) ##

pre.flu1 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.Phytoflash_2013_08_PD1.csv")
pre.flu2 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.Phytoflash_2013_09_PD1.csv")
pre.flu3 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.Phytoflash_2013_10_PD1.csv")
...
write.csv(flu, paste("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/phytoflash",cruise, sep=""), quote=F, row.names=F)
...
## oxygen ##
pre.ox0 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.Oxygen_2013_08_PD1.csv")
pre.ox1 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.Oxygen_2013_09_PD1.csv")
pre.ox2 <- read.csv("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/saturn03.240.A.Oxygen_2013_10_PD1.csv")
pre.ox0 <- as.data.frame(pre.ox1, row.names=NULL)
pre.ox1 <- as.data.frame(pre.ox1, row.names=NULL)
pre.ox2 <- as.data.frame(pre.ox2, row.names=NULL)
ox<- rbind(pre.ox0, pre.ox1, pre.ox2)

ox$time <- as.POSIXct(strptime(ox$time, "%Y/%m/%d %H:%M:%S"), tz="GMT")

write.csv(ox, paste("/Users/francois/Documents/DATA/SeaFlow/CMOP/CMOP_git/auxillary_data/oxygen",cruise, sep=""), quote=F, row.names=F)
...
# ## elevation ##
# pre.ele1 <- read.csv("/Users/francois/CMOP/auxillary_data/saturn03.1480.A.CTD_2013_09_PD0.csv")
# pre.ele2 <- read.csv("/Users/francois/CMOP/auxillary_data/saturn03.1480.A.CTD_2013_10_PD0.csv")
# pre.ele1 <- as.data.frame(pre.ele1, row.names=NULL)
# pre.ele2 <- as.data.frame(pre.ele2, row.names=NULL)
# ele <- rbind(pre.ele1, pre.ele2)

# ele$time <- as.POSIXct(strptime(ele$time, "%Y/%m/%d %H:%M:%S"), tz="GMT")
# plot(ele$time, ele$elevation)
# write.csv(ele, paste("/Users/francois/CMOP/auxillary_data/elevation",cruise, sep=""), quote=F, row.names=F)
...
# ## bulk orange ##
# pre.tur0 <- read.csv("/Users/francois/CMOP/auxillary_data/saturn03.240.A.CyanoWatch_2013_08_PD0.csv")
...
## double plot ##
par(cex=2)
plot(crypto$time, crypto$abundance,ylim=c(0,0.8), pch=16, xlab="time", ylab="abundance (10^6 cells/L)", main="Cryptophyte", cex.pch=1)

par(new=T)

plot(flu$time, flu$water_salinity, col="blue", pch=16, xlab="", ylab="", cex.lab=1.5, axes=F)
par(mai=c(1,1.5,1,1))
axis(4)
